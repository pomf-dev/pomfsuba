 ...
 * ============================================================
 *
 * Country flags are ONLY displayed on /int/.
 *
 * The country code is stored in posts.country_code.
 *
 * Example:
 *
 ...
 *
 * The actual flag filename is resolved by the shared
 * get_country_flag_url() helper from config.php.
 */
 ...
 * COUNTRY FLAGS
 *
 * Flags are intentionally restricted to /int/.
 */
    ...
    >
        ...
        <p class="intro">
            ...
            <a
                ...
                href="/<?= rawurlencode($board['slug']) ?>/thread/<?= (int) $thread['id'] ?>#p<?= (int) $post['id'] ?>"
            >
                No.<?= (int) $post['id'] ?>
            </a>
...
(function () {
    ...
    /*
     * Escape closes the report dialog.
     */
    ...
    if (quickReply) {
        ...
        function showQuickReply(threadId, postId) {
            ...
            /*
             * Copy values from the normal post form.
             */
        ...
        /*
         * Keep regular form and Quick Reply fields
         * synchronized.
         */
    ...
    /*
     * Reload pages restored from browser
     * back/forward cache.
     */
